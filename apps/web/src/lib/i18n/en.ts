...
export const en: Translations = {
  ...
  abonnement: {
    ...
    statutCard: {
      ...
      essai: 'TRIAL',
      enAttente: 'PENDING',
      autreStatut: 'INACTIVE',
      renew: '🔄 Renew',
      changeFormule: '📦 Change plan',
      loading: 'Loading your subscription…',
    },

    voucherInline: {
      button: '🎟️ I have an activation key (voucher)',
      title: '🎟️ Enter activation key',
      label: 'Activation code',
      hint: 'A valid code activates your subscription immediately.',
      submit: 'Redeem code',
      cancel: 'Cancel',
    },
...
<p>They display example figures, hard-coded, that come from no database. They exist to show the shape these modules will take, not to work with.</p>`,
  ...
  commissions: {
    ...
    plans: {
      ...
      empty: 'No rate plan configured',
      palierHeader: 'Volume-based tiers',
      colVolumeMin: 'Min volume (XOF)',
      colVolumeMax: 'Max volume (XOF)',
      colTauxAgent: 'Agent rate (%)',
      colTauxReseau: 'Network rate (%)',
      unlimitedMax: '∞',
      plafondMensuel: 'Monthly cap (agent)',
      none: 'None',
      typeCalcul: 'Calculation mode',
      simulator: 'Simulator',
      simVolume: 'Agent monthly volume (XOF)',
      simMontant: 'Transaction amount (XOF)',
      simResult: 'Estimated commission',
      simBtn: '▶ Calculate',
      addPalier: '+ Add tier',
      palierSaved: 'Tier added successfully.',
      noPaliers: 'No volume tiers configured on this plan (SIMPLE mode).',
    },
    ...
    tableau: {
      ...
      selectYear: 'Year',
      colAgent: 'Agent',
      colVolume: 'Monthly volume',
      colPalier: 'Applied tier',
      colBrute: 'Gross commission',
      colPlafond: 'Cap reached?',
      colNette: 'Net commission',
      total: 'Total to pay',
      exportCsv: '⬇ Export CSV',
      loading: 'Loading…',
      empty: 'No commissions this month',
      yes: 'YES ⚠',
      no: '—',
    },

    historique: {
      chartTitle: 'Commission trend — last 6 months',
  ...
  profile: {
    ...
    photoRemove: 'Remove',
    photoConfirm: 'Confirm',
    photoCancel: 'Cancel',
    photoHint: 'JPG, PNG or WebP — max 2 MB',
    photoUploading: 'Uploading…',
    photoSuccess: 'Photo updated',
    photoError: 'Upload failed',
    photoSizeError: 'File too large (max 2 MB)',
    photoFormatError: 'Unsupported format (JPG, PNG, WebP only)',
    // Change password
    ...
    sessionsColDevice: 'Device',
    sessionsColIp: 'IP Address',
    sessionsColDate: 'Connected',
    sessionsColActions: 'Actions',
    sessionsCurrent: 'Current session',
    sessionsRevoke: 'Revoke',
    sessionsRevoking: 'Revoking…',
    sessionsRevokeAll: 'Revoke all others',
    sessionsRevokeAllConfirm: 'This will sign out all your other devices. Continue?',
