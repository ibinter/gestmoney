...
export const fr = {
  ...
  abonnement: {
    ...
    statutCard: {
      ...
      autreStatut: 'INACTIF',
      renew: '🔄 Renouveler',
      changeFormule: '📦 Changer de formule',
      loading: 'Chargement de votre abonnement…',
    },

    voucherInline: {
      button: '🎟️ J\'ai une clé d\'activation (voucher)',
      title: '🎟️ Saisir une clé d\'activation',
      label: 'Code d\'activation',
      hint: 'Un code valide active votre abonnement immédiatement.',
...
<p>Ils affichent des chiffres d'exemple, figés, qui ne viennent d'aucune base de données. Ils servent à montrer la forme que prendront ces modules, pas à travailler.</p>`,
  ...
  commissions: {
    ...
    plans: {
      title: 'Plans tarifaires actifs',
      empty: 'Aucun plan tarifaire configuré',
      palierHeader: 'Paliers par volume mensuel',
      colVolumeMin: 'Volume min (FCFA)',
      colVolumeMax: 'Volume max (FCFA)',
      colTauxAgent: 'Taux agent (%)',
      colTauxReseau: 'Taux réseau (%)',
      unlimitedMax: '∞',
      plafondMensuel: 'Plafond mensuel agent',
      none: 'Aucun',
      typeCalcul: 'Type de calcul',
      simulator: 'Simulateur',
      simVolume: 'Volume mensuel de l\'agent (FCFA)',
      simMontant: 'Montant d\'une transaction (FCFA)',
      simResult: 'Commission estimée',
      simBtn: '▶ Calculer',
      addPalier: '+ Ajouter un palier',
      palierSaved: 'Palier ajouté avec succès.',
      noPaliers: 'Aucun palier volume configuré sur ce plan (mode SIMPLE).',
    },
    ...
    tableau: {
      ...
      selectYear: 'Année',
      colAgent: 'Agent',
      colVolume: 'Volume mensuel',
      colPalier: 'Palier appliqué',
      colBrute: 'Commission brute',
      colPlafond: 'Plafond atteint ?',
      colNette: 'Commission nette',
      total: 'Total à payer',
      exportCsv: '⬇ Exporter CSV',
      loading: 'Chargement…',
      empty: 'Aucune commission ce mois',
      yes: 'OUI ⚠',
      no: '—',
    },

    historique: {
      chartTitle: 'Évolution des commissions — 6 derniers mois',
      noData: 'Pas de données suffisantes pour afficher le graphique.',
    },
  },
  ...
  profile: {
    ...
    photoConfirm: 'Confirmer',
    photoCancel: 'Annuler',
    photoHint: 'JPG, PNG ou WebP — max 2 Mo',
    photoUploading: 'Envoi…',
    photoSuccess: 'Photo mise à jour',
    photoError: 'Erreur lors de l\'envoi',
    photoSizeError: 'Image trop volumineuse (max 2 Mo)',
    photoFormatError: 'Format non supporté (JPG, PNG, WebP uniquement)',
    // Changement de mot de passe
    pwdTitle: 'Changer le mot de passe',
    pwdCurrent: 'Mot de passe actuel',
    pwdNew: 'Nouveau mot de passe',
    pwdConfirm: 'Confirmer le nouveau mot de passe',
    pwdStrength: 'Force :',
    pwdWeak: 'Faible',
    pwdMedium: 'Moyen',
    pwdStrong: 'Fort',
    ...
    pwdSubmit: 'Changer le mot de passe',
    pwdSubmitting: 'Modification…',
    pwdSuccess: 'Mot de passe modifié avec succès',
    pwdError: 'Erreur lors du changement de mot de passe',
    // Sessions actives
    sessionsTitle: 'Sessions actives',
    sessionsSubtitle: 'Appareils connectés à votre compte',
    sessionsColDevice: 'Appareil',
    sessionsColIp: 'Adresse IP',
    sessionsColDate: 'Connexion',
    sessionsColActions: 'Actions',
    sessionsCurrent: 'Session courante',
    sessionsRevoke: 'Révoquer',
    sessionsRevoking: 'Révocation…',
    sessionsRevokeAll: 'Révoquer toutes les autres',
    sessionsRevokeAllConfirm: 'Cela déconnectera tous vos autres appareils. Continuer ?',
